...
data_dirs = ["../../data/dems/south-cascade", "../../data/dems/mount-baker"]

if __name__ == "__main__":
    workers = psutil.cpu_count(logical=True) - 1

    client = gtsa.io.dask_start_cluster(workers, ip_addres=None, port=":8786")
    ...
    for data_dir in data_dirs:
        ...
        ds = xr.open_dataset(
            zarr_fn, chunks={"time": tc, "y": yc, "x": xc}, engine="zarr"
        )
